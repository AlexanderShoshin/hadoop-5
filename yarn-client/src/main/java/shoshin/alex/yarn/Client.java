...
public class Client {
  ...
  private String appName = "yarn-application";
  // App master priority
  ...
  private String shellCommand = "/bin/date"; 
  ...
  private static final String SCRIPT_PATH = "ExecScript";
  ...
  public Client(Configuration conf) throws Exception  {
    this("shoshin.alex.yarn.ApplicationMaster", conf);
  }
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    } else if (!cliParser.hasOption("jar")) {
